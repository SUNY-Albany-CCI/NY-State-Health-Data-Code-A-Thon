  ...
  onSocketMessage: function(ewd) {
    ...
    NYSDatacallback = function(response) {
      ...
      response.on('end', function () {
        ...
        var dataNYStateJSON = JSON.parse(dataNYState);

        savedMsg._setDocument(dataNYStateJSON);
        ewd.log('*** NYSDATA Incoming Web Socket message received: ' + JSON.stringify(dataNYStateJSON, null, 2), 1);
